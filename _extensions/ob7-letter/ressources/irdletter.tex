...
\includegraphics[height=5cm]{_extensions/ob7-letter/ressources/logo_ird_hauteur_coul}
  \end{textblock}%
    \hfill
  \includegraphics[height=2.5cm]{_extensions/ob7-letter/ressources/logo_ob7}
}
\fancyfoot[C]{
  ...
  \includegraphics[height=1.5cm]{_extensions/ob7-letter/ressources/logo_marbec}~~~
  \includegraphics[height=1.5cm]{_extensions/ob7-letter/ressources/logo_feamp}~~~
  %\includegraphics[height=1.2cm]{_extensions/ob7-letter/ressources/logo_UE}
  \end{textblock}
  \def\thepage{}
}
}
